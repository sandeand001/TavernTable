...
import { GameValidators as DefaultGV, Sanitizers as DefaultSZ } from '../../src/utils/Validation.js';
...
describe('TerrainCoordinator dependency resolution', () => {
  test('falls back to module defaults and attaches them when globals missing', () => {
    ...
    try {
      ...
      if (prevGV) global.GameValidators = prevGV; else delete global.GameValidators;
      if (prevSZ) global.Sanitizers = prevSZ; else delete global.Sanitizers;
    }
  });
});
